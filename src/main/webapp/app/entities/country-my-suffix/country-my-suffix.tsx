...
import { getEntities } from './country-my-suffix.reducer';
import { ICountryMySuffix } from 'app/shared/model/country-my-suffix.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';

export interface ICountryMySuffixProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export class CountryMySuffix extends React.Component<ICountryMySuffixProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="country-my-suffix-heading">
