...
export type IJobMySuffixState = IPaginationBaseState;

export class JobMySuffix extends React.Component<IJobMySuffixProps, IJobMySuffixState> {
  state: IJobMySuffixState = {
